...
export default function CreateEventForm({ onClose }: CreateEventFormProps) {
  ...
  // Title ရိုက်ထည့်သည့် အခါ Trigger ဖြစ်မည့် Handler
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border rounded-lg text-sm bg-transparent outline-none transition focus:ring-2 focus:ring-indigo-500 border-input text-foreground placeholder:text-muted-foreground scheme-light dark:scheme-dark"
            />
          </div>
